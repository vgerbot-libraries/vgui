...
fn named_color(name: &str, shade: Option<&str>) -> Option<(u8, u8, u8)> {
    if shade.is_none() {
        return match name {
            "black" => Some((0, 0, 0)),
            "white" => Some((255, 255, 255)),
            "transparent" => None, // handled specially
            "current" => None,
            "inherit" => None,
            _ => None,
        };
...
macro_rules! pal {
    ($name:ident, $($shade:literal => $r:literal,$g:literal,$b:literal),*) => {
        const $name: &[(&str, u8, u8, u8)] = &[
            $(($shade, $r, $g, $b),)*
        ];
    };
}
...
pal!(GRAY,
    ...
    "400"=>156,163,175, "500"=>107,114,128, "600"=>75,85,99, "700"=>67,72,84,
...
pal!(FUCHSIA,
    ...
    "400"=>232,121,249, "500"=>217,70,239, "600"=>192,38,211, "700"=>162,28,190,
    "800"=>134,25,143, "900"=>112,26,117, "950"=>74,17,77);
